...
<body>
    ...
    <div class="app-header">
        ...
        <div class="header-right">
            ...
            @else
                <span class="credits-pill">⚡ <strong id="credits-count">{{ auth()->user()->credits }}</strong> credits
                    left</span>
            @endif
        ...
        <div class="preview-panel">
            <div class="preview-toolbar">
                ...
                <div style="display:flex; gap:.4rem;">
                    <button class="btn btn-outline" id="btn-regen" onclick="regenerate()" disabled
                        style="font-size:.82rem;">↺ Regenerate</button>
                    <button class="btn btn-accent" id="btn-dl2" onclick="downloadPDF()" disabled
                        style="font-size:.82rem;">⬇ Download PDF</button>
                </div>
            </div>
    ...
    <script>
        ...
        async function sendMessage() {
            ...
            try {
                ...
                if (res.status === 402) {
                    addMsg('ai',
                        `You've used all your free credits. <a href="${UPGRADE_URL}" style="color:var(--accent);font-weight:600;">Upgrade to Pro →</a>`
                        );
                } else {
